 ...
 */
declare const mergeEvents: (events: PageEventType[]) => PageEventType | null;
/**
 * Watch page files and deps, return file watchers and cleanup function
 */
declare const watchPageFiles: (app: App) => {
  watchers: FSWatcher[];
...
//#endregion
//#region src/commands/dev/watchUserStyleFile.d.ts
declare const watchUserStyleFile: (app: App) => FSWatcher;
//#endregion
...
//#endregion
export { type BaseCommandCliOptions, type BaseCommandOptions, type BuildCommand, type BuildCommandCliOptions, type DevCommand, type DevCommandCliOptions, type InfoCommand, PageDepsHelper, type UserConfig, build, cli, createPageDepsHelper, defineUserConfig, dev, handlePageAdd, handlePageChange, handlePageUnlink, info, loadUserConfig, mergeEvents, processPagePatterns, resolveAppConfig, resolveCliAppConfig, resolveConfig, resolveUserConfig, resolveUserConfigConventionalPath, resolveUserConfigPath, transformUserConfigToPlugin, watchPageFiles, watchUserConfigFile, watchUserStyleFile };